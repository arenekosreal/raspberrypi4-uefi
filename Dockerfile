...
RUN pacman-key --init &&\
    ...
    pacman -S glibc git acpica python rsync bc xmlto docbook-xsl kmod inetutils aarch64-linux-gnu-gcc openssh bc libelf cpio perl tar xz gcc10 --noconfirm --needed &&\
