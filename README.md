...
- Choose packages you need to install. Normally, packages provide `uefi-raspberrypi4`,`linux-rpi4-uefi`,`raspberrypi4-dtbs` and `raspberrypi4-overlays` are needed to be installed. You may have to remove `uboot-raspberrypi` in your original ArchLinuxARM Distribution.
